...
class Ui_select(object):
    def setupUi(self, selectui):
        ...
        self.propertiespushButton.setGeometry(QtCore.QRect(60, 160, 80, 23))
    ...
    def retranslateUi(self, selectui):
        ...
        self.SelectMainTitle.setText(
            _translate("MainWindow", "Select Options"))
        self.propertiespushButton.setText(
